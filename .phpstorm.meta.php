...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.links./var/www/html/public/storage','logging.default',
...
'logging.channels.null.driver','logging.channels.null.handler','logging.channels.emergency.path','logging.channels.bugsnag.driver','mail.default',
...
'openai.api_key','openai.organization','openai.request_timeout','queue.default','queue.connections.sync.driver',
...
'bugsnag.strip_path','bugsnag.strip_path_regex','bugsnag.query','bugsnag.bindings','bugsnag.release_stage',
...
'bugsnag.feature_flags','bugsnag.max_breadcrumbs','bugsnag.attach_hidden_context','ide-helper.filename','ide-helper.models_filename',
...
'filament.exports.download','filament.imports.failed-rows.download','sanctum.csrf-cookie','livewire.update','livewire.upload-file','livewire.preview-file','pets.index','pets.store',
'pets.show','pets.update','pets.destroy',
'events.index','events.store','events.show','events.update','events.destroy','storage.local',);
...
'laravelEnum::messages.enum','laravelEnum::messages.enum_value','laravelEnum::messages.enum_key','filament-actions::associate.single.label','filament-actions::associate.single.modal.heading',
...
'PHP_CLI_SERVER_WORKERS','SANCTUM_STATEFUL_DOMAINS','SESSION_DRIVER','BCRYPT_ROUNDS','LOG_CHANNEL',
'LOG_STACK','LOG_DEPRECATIONS_CHANNEL','LOG_LEVEL','DB_CONNECTION','DB_HOST',
'DB_PORT','DB_DATABASE','DB_USERNAME','DB_PASSWORD','DB_ROOT_PASSWORD',
...
'AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','LOG_STACK','OPENAI_API_KEY',
'OPENAI_ORGANIZATION','BUGSNAG_API_KEY',);
